...
# Load local .env if present so API_KEY can be stored in project config.
def _load_local_env():
...
# 🔐 API KEY from environment or local .env
API_KEY = os.environ.get('API_KEY')

if not API_KEY:
    raise ValueError(
        'API_KEY not found. Set environment variable or create a .env file with API_KEY=your_key.'
    )
